<template>
  <div class="mt-4 rounded overflow-hidden border border-gray-200">
    <div class="p-2 bg-gray-300">
      <div class="text-gray-600 font-medium text-sm">LINKS</div>
    </div>
...
<script>
import QuickLinkItem from './QuickLinkItem.json'
