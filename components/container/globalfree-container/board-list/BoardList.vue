    ...
    <div class="bg-white mt-4 rounded border border-gray-200 overflow-hidden">
      <div class="p-4 border-b border-gray-200">
        ...
        <div class="flex items-center justify-between mt-2">
          ...
          <NuxtLink :to="{ name: 'globalfree-create' }">
            <svg
              class="w-5 h-5 text-navy"
              fill="none"
              stroke="currentColor"
...
export default {
  ...
  async fetch() {
    ...
    await this.$store.dispatch('globalfree/getPostList', param).then(() => {
      this.posts = this.$store.state.globalfree.posts
    })
  },
  methods: {
    openSearchModal() {
